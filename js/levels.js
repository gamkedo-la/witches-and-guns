...
export const LEVELS = [
	{
		...
		waves: [
			{
				spawners: [
					{ cls: BroomEnemy, x: 162, y: 1 },
					{ cls: BroomEnemy, x: 160, y: 3 },
					{ cls: BroomEnemy, x: 161, y: 5 },
					{ cls: BroomEnemy, x: 159, y: 7 },
					{ cls: BroomEnemy, x: 158, y: 9 },
					{ cls: BroomEnemy, x: 161, y: 3 },
					{ cls: BroomEnemy, x: 160, y: 5 },
					{ cls: BroomEnemy, x: 155, y: 2 },
					{ cls: BroomEnemy, x: 163, y: 4 },
				],
				timeOut: 12,
			},
			{
				spawners: [
					{ cls: BroomEnemy, x: 302, y: 101 },
					{ cls: BroomEnemy, x: 304, y: 103 },
					{ cls: BroomEnemy, x: 305, y: 105 },
					{ cls: BroomEnemy, x: 301, y: 107 },
					{ cls: BroomEnemy, x: 303, y: 99 },
					{ cls: BroomEnemy, x: 305, y: 97 },
					{ cls: BroomEnemy, x: 299, y: 95 },
					{ cls: BroomEnemy, x: 295, y: 92 },
					{ cls: BroomEnemy, x: 293, y: 104 },
				],
				timeOut: 20,
			},
			{
				spawners: [
					{ cls: BroomEnemy, x: 0, y: 101 },
					{ cls: BroomEnemy, x: 0, y: 103 },
					{ cls: BroomEnemy, x: 0, y: 105 },
					{ cls: BroomEnemy, x: 0, y: 107 },
					{ cls: BroomEnemy, x: 0, y: 99 },
					{ cls: BroomEnemy, x: 0, y: 97 },
					{ cls: BroomEnemy, x: 0, y: 95 },
					{ cls: BroomEnemy, x: 0, y: 92 },
					{ cls: BroomEnemy, x: 0, y: 104 },

					{ cls: BroomEnemy, x: 162, y: 222 },
					{ cls: BroomEnemy, x: 160, y: 224 },
					{ cls: BroomEnemy, x: 161, y: 220 },
					{ cls: BroomEnemy, x: 159, y: 228 },
					{ cls: BroomEnemy, x: 158, y: 226 },
					{ cls: BroomEnemy, x: 161, y: 225 },
					{ cls: BroomEnemy, x: 160, y: 221 },
					{ cls: BroomEnemy, x: 155, y: 230 },
					{ cls: BroomEnemy, x: 163, y: 218 },
				],
				timeOut: Infinity,
			},
			{
				spawners: [
					{ cls: ShovelEnemy, x: 162, y: 1 },
					{ cls: ShovelEnemy, x: 160, y: 3 },
					{ cls: ShovelEnemy, x: 161, y: 5 },
					{ cls: ShovelEnemy, x: 159, y: 7 },
					{ cls: ShovelEnemy, x: 158, y: 9 },
					{ cls: ShovelEnemy, x: 161, y: 3 },
					{ cls: ShovelEnemy, x: 160, y: 5 },
					{ cls: ShovelEnemy, x: 155, y: 2 },
					{ cls: ShovelEnemy, x: 163, y: 4 },
				],
				timeOut: 12,
			},
			{
			...
			{
				spawners: [
					{ cls: ShovelEnemy, x: 0, y: 101 },
					{ cls: ShovelEnemy, x: 0, y: 103 },
					{ cls: ShovelEnemy, x: 0, y: 105 },
					{ cls: ShovelEnemy, x: 0, y: 107 },
					{ cls: ShovelEnemy, x: 0, y: 99 },
					{ cls: ShovelEnemy, x: 0, y: 97 },
					{ cls: ShovelEnemy, x: 0, y: 95 },
					{ cls: ShovelEnemy, x: 0, y: 92 },
					{ cls: ShovelEnemy, x: 0, y: 104 },
				],
				timeOut: Infinity,
			},
			{
				spawners: [
					{ cls: ShovelEnemy, x: 162, y: 222 },
					{ cls: ShovelEnemy, x: 160, y: 224 },
					{ cls: ShovelEnemy, x: 161, y: 220 },
					{ cls: ShovelEnemy, x: 159, y: 228 },
					{ cls: ShovelEnemy, x: 158, y: 226 },
					{ cls: ShovelEnemy, x: 161, y: 225 },
					{ cls: ShovelEnemy, x: 160, y: 221 },
					{ cls: ShovelEnemy, x: 155, y: 230 },
					{ cls: ShovelEnemy, x: 163, y: 218 },
				],
				timeOut: Infinity,
			},
		...
		unwalkables: [],
		boss: { cls: LawnMowerBoss, x: 154, y: 4 }
	},
	{
